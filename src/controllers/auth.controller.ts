...
class AuthController {
    public async signUpAdmin(req: Request, res: Response, next: NextFunction):Promise<any> {
        try {
    ...
    public async signInAdmin(req: Request, res: Response, next: NextFunction):Promise<any> {
        try {
